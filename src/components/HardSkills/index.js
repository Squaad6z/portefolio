      ...
      <section className='hard_skills_content'>
        <div className="perspective">
          <div className="card rotate-effect">
            <span>
            <h2>HTML5</h2>
            <img className='card_logo' alt='hardskills logo' src='../images/Html5.webp'></img>
            </span>
        ...
        <div className="perspective">
          <div className="card rotate-effect">
            <span>
            <h2>CSS</h2>
            <img className='card_logo' alt='hardskills logo' src='../images/css3.webp'></img>
            </span>
        ...
        <div className="perspective">
          <div className="card rotate-effect">
            <span>
            <h2>JAVASCRIPT</h2>
            <img className='card_logo' alt='hardskills logo' src='../images/js.webp'></img>
            </span>
        ...
        <div className="perspective">
          <div className="card rotate-effect">
            <span>
            <h2>REACT</h2>
            <img className='card_logo' alt='hardskills logo' src='../images/react.webp'></img>
            </span>
        ...
        <div className="perspective">
          <div className="card rotate-effect">
            <span>
            <h2>REDUX</h2>
            <img className='card_logo' alt='hardskills logo' src='../images/redux.webp'></img>
            </span>
        ...
        <div className="perspective">
          <div className="card rotate-effect">
            <span>
            <h2>NEXT.JS</h2>
            <img className='card_logo' alt='hardskills logo' src='../images/next.webp'></img>
            </span>
