...
const HardSkills = () => {
  return (
    <section className='content'>
      <aside className='content_box'>
      <div className='box html'>
        <span className="--i:1;"><img src='../images/Html5.webp' alt='html5'></img></span>
      ...
      <div className='box css'>
        <span className="--i:2;"><img src='../images/css3.webp' alt='css3'></img></span>
      ...
      <div className='box js'>
        <span className="--i:3;"><img src='../images/js.webp' alt='javascript'></img></span>
      ...
      <div className='box react'>
        <span className="--i:4;"><img src='../images/react.webp' alt='react'></img></span>
      ...
      <div className='box redux'>
        <span className="--i:5;"><img src='../images/redux.webp' alt='redux'></img></span>
      ...
      <div className='box next'>
        <span className="--i:6;"><img src='../images/next.webp' alt='nextjs'></img></span>
